...
const SchoolsSection = () => {
  const schools = [
    ...
    },
    {
      ...
      slug: "product",
      description: "Drive innovation through product strategy and design thinking",
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: "Master digital storytelling, media production, and creative technologies",
      icon: Palette,
    ...
    },
    {
      ...
      slug: "computing",
      description: "Build fluency in languages, professional communication, and cross-cultural skills",
      icon: Cpu,
