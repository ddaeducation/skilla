...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are an expert educational grader. Your task is to evaluate student answers fairly and provide constructive feedback. 
Be encouraging but honest. Focus on what the student did well and what they can improve.
Grade consistently based on the rubric or expected answer when provided.`;
...
Please evaluate the answer and return a JSON object with:
1. "score": A number from 0 to ${maxPoints} (can be partial credit)
2. "feedback": Constructive feedback explaining the grade (2-4 sentences). Start with what was done well, then mention any issues or improvements needed.
3. "isCorrect": true if the answer deserves full or nearly full credit (80%+), false otherwise
